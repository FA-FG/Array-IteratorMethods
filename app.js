...
// Complete the exercise in the space below:
inventorNames = inventors.map((name) => {
...
// Complete the exercise in the space below:
sortedByBirthYear = inventors.sort((from, to) => {
...
inventorNamedAda = inventors.find((name) => {
...
// Complete the exercise in the space below:
isEveryone19OrOlder = devs.every((ele) => {
  let age = 2024 - ele.year
  return age > 18
})
...
// Complete the exercise in the space below:
totalYearsLived = inventors.reduce((accumulator, lifespan) => {
  let x = accumulator + (lifespan.passed - lifespan.year)
  return x
}, 0)
...
// Complete the exercise in the space below:
travelMethodCounts = travelMethods.reduce((accumulator, ele, index) => {
  // if el  exists as a key in the acc object, it increments the count; if it doesn't exist, it initializes the count to 0
  accumulator[ele] = (accumulator[ele] || 0) + 1
  return accumulator
}, {})
